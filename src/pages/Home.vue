...
<template>
  <div class="gallery">
    <div class="row p-3 d-flex justify-content-center">
      <div
        class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12 m-2 p-2 rounded-3"
        v-for="apartment in apartments"
        :key="apartment.id"
      >
        <div
          :id="'carouselExampleIndicators' + apartment.id"
        ...
        >
          ...
          <div class="carousel-inner">
            <div
              class="card-image p-0 carousel-item active"
              :class="{ active: index === 0 }"
            >
              <img
                :src="getImgUrl(apartment)"
                class="card-img-top rounded-3 p-2 d-block img-fluid w-100 h-100"
                style="max-height: 300px; min-height: 220px; object-fit: cover"
                alt=""
              />
            </div>
          </div>
